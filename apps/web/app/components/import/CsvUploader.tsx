  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          borderColor:     isDragging ? "var(--violet-from)" : "var(--bg-elevated)",
          backgroundColor: isDragging ? "rgba(124,58,237,0.04)" : "var(--bg-card)",
        }}
      >
        {/* Icon */}
        <div
          className="flex h-11 w-11 items-center justify-center rounded-full transition-colors duration-150"
          style={{ backgroundColor: isDragging ? "rgba(124,58,237,0.12)" : "var(--bg-elevated)" }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} style={{ color: isDragging ? "var(--violet-from)" : "var(--text-muted)" }}>
