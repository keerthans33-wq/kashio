...
function friendlyError(message: string): string {
  ...
  if (message.includes("Email not confirmed"))       return "Check your email and click the confirmation link first.";
  if (message.includes("Password should be at least")) return "Password must be at least 6 characters.";
  if (message.includes("rate limit") || message.includes("too many")) return "Too many attempts. Please wait a moment.";
  return message;
}
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-5">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-violet-500 focus:outline-none"
          />
          <input
            type="password"
